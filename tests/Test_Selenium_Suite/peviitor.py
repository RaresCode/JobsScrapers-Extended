...
class Peviitor:
    ...
    search_input_css = "div.input-container.query > input"
    search_job_css = "section > section > section.main-wrapper > main > form > button"
    ...
    def get_all_job_titles(self):
        ...
        return [job_title.text for job_title in job_titles]
    ...
    def get_all_job_companies(self):
        ...
        return [job_company.text for job_company in job_companies]
    ...
    def get_all_job_locations(self):
        ...
        return [job_location.text for job_location in job_locations]
    ...
    def get_all_job_urls(self):
        ...
        return [job_url.get_attribute("href") for job_url in job_urls]